...
while(1):
	...
	#
	print("Aguardando quadro da requisição HTTP da camada física...")
	print("\n")
	...
	#
	print("Enviando segmento da requisição HTTP para a camada de transporte...")
	print("\n")
...
while(1):
	...
	#
	print("Aguardando segmento da resposta HTTP da camada de transporte...")
	print("\n")
	con, cliente = tcp.accept()
	...
	#
	print("Enviando datagrama da resposta HTTP pra camada física...")
	print("\n")
	tcp2 = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
